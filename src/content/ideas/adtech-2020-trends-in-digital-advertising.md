...
\
**Ads.txt default.** In April, [Google introduced new brand safety-focused initiatives](https://martech.org/google-display-video-360-to-default-to-ads-txt-inventory-support-app-ads-txt/), including defaulting to ads.txt inventory, supporting app-ads.txt and providing a central hub for brand controls in the interface. It meant that only publishers that have adopted the standard and have placed ads.txt files on their sites will be eligible for bids from DV360.
